...
IMPORTANT: When running the booster in this mode, since it is not running in a managed container platform, the application does not automatically restart when it stops.
